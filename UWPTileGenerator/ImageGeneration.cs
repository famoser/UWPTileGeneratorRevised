...
namespace UWPTileGenerator
{
    ...
    public static class ImageGeneration
    {
        ...
        private static void PopulateTileSizes()
        {
            ...
            TileSizes.Add("StoreLogo.scale-100.png", new Size(50, 50));
            TileSizes.Add("StoreLogo.scale-125.png", new Size(63, 63));
            TileSizes.Add("StoreLogo.scale-150.png", new Size(75, 75));
            TileSizes.Add("StoreLogo.scale-200.png", new Size(100, 100));
            TileSizes.Add("StoreLogo.scale-400.png", new Size(200, 200));
        }
